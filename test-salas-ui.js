...
async function main() {
  ...
  ok(gd("create-baralhos").hidden === false && gd("create-nomes").hidden === false, "modo Mesa: grade livre dos 16 baralhos + campos de nome");
  ok(gd("decks").children.length === 16, "modo Mesa: 16 baralhos independentes");
  go("modo-classico");
  ok(gd("create-baralhos").hidden === false && gd("create-nomes").hidden === true, "toggle p/ Clássico: mesma grade, sem os nomes");
  go("do-create");
